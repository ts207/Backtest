...
from pipelines.ingest.ingest_binance_spot_ohlcv_15m import _read_ohlcv_from_zip
...
def test_spot_read_ohlcv_handles_archive_with_header_row(tmp_path: Path) -> None:
    zip_path = tmp_path / "spot_ohlcv_header.zip"
    _write_zip(
        zip_path,
        "\n".join(
            [
