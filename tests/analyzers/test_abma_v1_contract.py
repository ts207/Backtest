...
from analyzers.abma import DEFAULT_ABMA_CONFIG, output_schema


def test_abma_v1_constants_are_frozen() -> None:
    config = DEFAULT_ABMA_CONFIG
    assert config.def_version == "v1"
...
def test_abma_v1_output_schema_matches_doc() -> None:
