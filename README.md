...
```powershell
# 1) Ingest 15m OHLCV
python project\pipelines\ingest\ingest_binance_um_ohlcv_15m.py --run_id 20240101_120000 --symbols BTCUSDT,ETHUSDT --start 2023-06-01 --end 2023-07-10

# 2) Ingest funding rates
python project\pipelines\ingest\ingest_binance_um_funding.py --run_id 20240101_120000 --symbols BTCUSDT,ETHUSDT --start 2023-06-01 --end 2023-07-10

# 3) Build cleaned canonical 15m bars + aligned funding
python project\pipelines\clean\build_cleaned_15m.py --run_id 20240101_120000 --symbols BTCUSDT,ETHUSDT --start 2023-06-01 --end 2023-07-10
