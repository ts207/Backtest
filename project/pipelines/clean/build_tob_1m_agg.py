...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build 1m ToB aggregates from 1s snapshots")
    ...
    manifest = start_manifest("build_tob_1m_agg", args.run_id, params, inputs, outputs)
    ...
    try:
        for symbol in symbols:
            ...
            for file_path in sorted(files):
                ...
                resampler = data.resample("1min", on="timestamp")
                agg = resampler.agg({
                ...
                out_path = out_dir / f"tob_agg_{symbol}_1m_{month_key}.parquet"
