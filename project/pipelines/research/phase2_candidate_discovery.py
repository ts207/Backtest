...
# --- Extracted modules ---
from pipelines.research.phase2_shrinkage import (  # noqa: E402
    _TEMPLATE_DIRECTION,
    _TAU_BY_FAMILY_DAYS,
...
from pipelines.research.phase2_multiplicity import (  # noqa: E402
    _make_family_id,
    _resolved_sample_size,
    _resolve_state_context_column,
    _simes_p_value,
    _bool_mask_from_series,
    _apply_multiplicity_controls,
)
from pipelines.research.phase2_lambda_persistence import (  # noqa: E402
    _load_previous_lambda_maps,
...
def main():
    ...
    if plan_rows:
        ...
        for plan_row in plan_rows:
            ...
            results.append({
                ...
                "entry_lag_bars": entry_lag_bars,
                "gate_entry_lag_safe": bool(int(entry_lag_bars) >= 1),
                ...
                for horizon in horizons:
                    ...
                    def _add_res(
                        ...
                        results.append({
                            ...
                            "gate_entry_lag_safe": bool(int(args.entry_lag_bars) >= 1),
    ...
    save_lambda_state_json(
        fdr_df,
        reports_root / "phase2_lambda_state.json",
        run_id=args.run_id,
        event_type=args.event_type,
    )
