...
def main():
    ...
    run_parallel([
        ("project/pipelines/ingest/ingest_binance_um_ohlcv_5m.py", common_args + time_args),
    ...
    run_parallel([
        ("project/pipelines/clean/build_cleaned_5m.py", common_args + ["--market", "perp", "--force", str(args.force)]),
        ("project/pipelines/clean/build_cleaned_5m.py", common_args + ["--market", "spot", "--force", str(args.force)]),
    ])
