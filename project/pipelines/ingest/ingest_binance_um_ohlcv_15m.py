...
def main() -> int:
    parser = argparse.ArgumentParser(description="Ingest Binance USD-M OHLCV 15m from archives")
    ...
    manifest = start_manifest("ingest_binance_um_ohlcv_15m", run_id, params, inputs, outputs)
