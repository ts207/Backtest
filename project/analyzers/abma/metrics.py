...
from .events import _ensure_columns, _ensure_tz_aware, REQUIRED_QUOTES_COLUMNS, REQUIRED_TRADES_COLUMNS
...
def compute_structural_metrics(
    ...
    *,
    ...
    """Compute v1 structural metrics for events and matched controls."""
    _ensure_columns(events, {"event_id", "symbol", "session_date", "t0", "window_end", "abma_def_version"}, "events")
    _ensure_columns(controls, {"control_id", "event_id", "symbol", "tc"}, "controls")
    ...
    events_local["window_end"] = _ensure_tz_aware(events_local["window_end"], "events.window_end")
    controls_local["tc"] = _ensure_tz_aware(controls_local["tc"], "controls.tc")
