.PHONY: help test audit smoke check-conflicts run-core run-research-vsr run-research-deff run-research-lrl run-full clean-reports clean-run
...
check-conflicts:
	RUN_SMOKE=0 bash scripts/audit_repo.sh
